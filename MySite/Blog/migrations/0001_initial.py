    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cat_post', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='Blog.category', verbose_name='Категории')),
            ],
            options={
                'verbose_name': 'Пост',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments_post', to='Blog.posts', verbose_name='Статья')),
